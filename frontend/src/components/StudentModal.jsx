...
//       {/* Modal */}
//       <div className="overflow-y-auto  lg:overflow-y-visible relative bg-white rounded-[2rem] shadow-2xl w-full max-w-3xl max-h-[95vh] overflow-hidden flex flex-col z-10 animate-fade-up ring-1 ring-black/[0.04]">
...
//               {photoUrl && !imgError ? (
//                 <div className="relative w-[12.5rem] h-[15.5rem]">
//                   {!imgLoaded && (
...
//                 </div>
//               ) : (
//                 <div className="w-[12.5rem] h-[15.5rem] rounded-3xl bg-gradient-to-br from-primary-1 to-primary-2 text-brand-black flex items-center justify-center font-extrabold text-5xl ring-[3px] ring-primary-1/40 shadow-lg shadow-primary-1/20">
