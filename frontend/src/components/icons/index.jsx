...
export const LinkedInIcon = ({ className = "" }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={mergeClasses("w-5 h-5", className)}>
...
export const PinIcon = ({ className = "" }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="dodgerblue" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={mergeClasses("w-4 h-4", className)}>
...
export const ClubMembersIcon = ({ className = "" }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={mergeClasses("w-4 h-4 inline mr-1", className)}>
...
export const StudentCouncilIcon = ({ className = "" }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={mergeClasses("w-4 h-4 inline mr-1", className)}>
