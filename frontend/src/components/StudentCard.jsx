...
//             <Avatar
//               student={student}
//               className="w-[20%] min-w-[56px] max-w-[68px] aspect-square rounded-full flex-shrink-0"
//             />
...
export function CardSkeleton() {
  return (
    <div className="bg-white rounded-3xl border border-black/[0.04] p-5 space-y-4 shadow-sm">
      <div className="flex items-center gap-3">
